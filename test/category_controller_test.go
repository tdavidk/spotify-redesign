...
import (
	...
	"tdavidk/learn-golang-restful-api/model/domain"
...
func setupTestDB() *sql.DB {
	db, err := sql.Open("mysql", "root:root@tcp(localhost:8889)/learn_golang_restful_api_test")
...
func TestCreateCategorySuccess(t *testing.T) {
	...
	request.Header.Add("X-API-Key", "SECRETCODE")
...
func TestUpdateCategorySuccess(t *testing.T) {
	...
	tx, _ := db.Begin()
	categoryRepository := repository.NewCategoryRepository()
	category := categoryRepository.Save(context.Background(), tx, domain.Category{Name: "Iphone"})
	tx.Commit()
...
func TestListCategoriesSuccess(t *testing.T) {
	...
	categoryRepository := repository.NewCategoryRepository()
	category := categoryRepository.Save(context.Background(), tx, domain.Category{Name: "Iphone"})
	category2 := categoryRepository.Save(context.Background(), tx, domain.Category{Name: "Xiaomi"})
	tx.Commit()
